...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/b;->n:Landroid/content/Context;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/b;->o:Ljava/util/Map;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/b;->p:Ljava/lang/Object;
...
.method private h(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/b;->n:Landroid/content/Context;
...
.method private i(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/b;->p:Ljava/lang/Object;
    ...
    sget-object v2, Landroidx/work/impl/background/systemalarm/b;->m:Ljava/lang/String;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/b;->o:Ljava/util/Map;
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/b;->n:Landroid/content/Context;
    ...
    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/b;->o:Ljava/util/Map;
    ...
    invoke-virtual {p2, v2, p1, p3}, Landroidx/work/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method private k(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->g()Landroidx/work/impl/h;

    move-result-object p1

    invoke-virtual {p1}, Landroidx/work/impl/h;->r()V
...
.method private l(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    invoke-virtual {v0, v1, v3, v5}, Landroidx/work/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-interface {v3, p1}, Landroidx/work/impl/l/k;->i(Ljava/lang/String;)Landroidx/work/impl/l/j;
    ...
    :cond_0
    :try_start_2
    iget-object v6, v3, Landroidx/work/impl/l/j;->d:Landroidx/work/n;

    invoke-virtual {v6}, Landroidx/work/n;->c()Z
    ...
    :cond_1
    :try_start_3
    invoke-virtual {v3}, Landroidx/work/impl/l/j;->a()J

    move-result-wide v5

    invoke-virtual {v3}, Landroidx/work/impl/l/j;->b()Z
    ...
    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/b;->n:Landroid/content/Context;

    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->g()Landroidx/work/impl/h;

    move-result-object p3

    invoke-static {p2, p3, p1, v5, v6}, Landroidx/work/impl/background/systemalarm/a;->c(Landroid/content/Context;Landroidx/work/impl/h;Ljava/lang/String;J)V
    ...
    invoke-virtual {v3, v1, v2, v4}, Landroidx/work/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/b;->n:Landroid/content/Context;

    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->g()Landroidx/work/impl/h;

    move-result-object v2

    invoke-static {v1, v2, p1, v5, v6}, Landroidx/work/impl/background/systemalarm/a;->c(Landroid/content/Context;Landroidx/work/impl/h;Ljava/lang/String;J)V

    iget-object p1, p0, Landroidx/work/impl/background/systemalarm/b;->n:Landroid/content/Context;
...
.method private m(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    sget-object v0, Landroidx/work/impl/background/systemalarm/b;->m:Ljava/lang/String;
    ...
    invoke-virtual {p2, v0, v1, v3}, Landroidx/work/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->g()Landroidx/work/impl/h;

    move-result-object p2

    invoke-virtual {p2, p1}, Landroidx/work/impl/h;->v(Ljava/lang/String;)V
