...
.method constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->f()Landroidx/work/impl/utils/k/a;
    ...
    invoke-direct {p3, p1, p2, v0}, Landroidx/work/impl/k/d;-><init>(Landroid/content/Context;Landroidx/work/impl/utils/k/a;Landroidx/work/impl/k/c;)V

    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/c;->e:Landroidx/work/impl/k/d;
...
.method a()V
    ...
    invoke-interface {v0}, Landroidx/work/impl/l/k;->q()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/c;->e:Landroidx/work/impl/k/d;
    ...
    iget-object v5, v4, Landroidx/work/impl/l/j;->c:Ljava/lang/String;

    invoke-virtual {v4}, Landroidx/work/impl/l/j;->a()J
    ...
    invoke-virtual {v4}, Landroidx/work/impl/l/j;->b()Z

    move-result v6

    if-eqz v6, :cond_1

    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/c;->e:Landroidx/work/impl/k/d;

    invoke-virtual {v6, v5}, Landroidx/work/impl/k/d;->c(Ljava/lang/String;)Z
    ...
    check-cast v1, Landroidx/work/impl/l/j;

    iget-object v1, v1, Landroidx/work/impl/l/j;->c:Ljava/lang/String;
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/c;->e:Landroidx/work/impl/k/d;

    invoke-virtual {v0}, Landroidx/work/impl/k/d;->e()V
