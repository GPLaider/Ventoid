...
.field private deferredComponentManager:Lio/flutter/embedding/engine/f/a;
...
.field private localizationPlugin:Le/a/c/b/a;
...
.method private handlePlatformMessageResponse(I[B)V
    ...
    invoke-interface {v0, p1, p2}, Lio/flutter/embedding/engine/e/c;->d(I[B)V
...
.method computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Le/a/c/b/a;
    ...
    :cond_5
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Le/a/c/b/a;

    invoke-virtual {p1, v0}, Le/a/c/b/a;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Le/a/b;->f(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/c$f;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Le/a/c/a/p;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/c$f;->J:I
...
.method public handlePlatformMessage(Ljava/lang/String;[BI)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lio/flutter/embedding/engine/e/c;->e(Ljava/lang/String;[BI)V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/j;->Q(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/j;->R(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lio/flutter/embedding/engine/f/a;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-interface {v0, p1, v1}, Lio/flutter/embedding/engine/f/a;->d(ILjava/lang/String;)V
    ...
    invoke-static {p1, v0}, Le/a/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setDeferredComponentManager(Lio/flutter/embedding/engine/f/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lio/flutter/embedding/engine/f/a;

    if-eqz p1, :cond_0

    invoke-interface {p1, p0}, Lio/flutter/embedding/engine/f/a;->c(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Le/a/c/b/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Le/a/c/b/a;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, v0}, Le/a/d/b;->b(ZLjava/lang/Object;)V
